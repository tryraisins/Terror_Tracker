...
const dataSources = [
    ...
    { name: "The Guardian Nigeria", type: "News" },
    { name: "Daily Post", type: "News" },
    { name: "News Central", type: "News" },
    { name: "Arise News", type: "News" },
    { name: "TVC News", type: "News" },
    { name: "ThisDay", type: "News" },
    { name: "The Nation", type: "News" },
    { name: "Leadership", type: "News" },
    { name: "Sun News", type: "News" },
    { name: "Tribune Online", type: "News" },
    { name: "Blueprint", type: "News" },
    { name: "Business Day", type: "News" },
    { name: "The Whistler", type: "News" },
    { name: "ICIR", type: "Inv. Journalism" },
    { name: "Ripples Nigeria", type: "News" },
    { name: "Daily Nigerian", type: "News" },
    { name: "PRNigeria", type: "Security News" },
    { name: "Reuters", type: "Wire" },
    { name: "AFP", type: "Wire" },
    { name: "Al Jazeera", type: "Intl. News" },
    { name: "BBC", type: "Intl. News" },
    { name: "CNN", type: "Intl. News" },
    { name: "DW", type: "Intl. News" },
    { name: "France 24", type: "Intl. News" },
    { name: "Voice of America", type: "Intl. News" },
    { name: "Associated Press", type: "Wire" },
    { name: "ACLED", type: "Database" },
    { name: "Zagazola Makama", type: "Security" },
    { name: "Nigeria Risk Index", type: "Security" },
