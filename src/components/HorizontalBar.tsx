                    ...
                    <div key={i} className="group">
                        <div className="flex items-center justify-between mb-1">
                            ...
                            <div className="flex items-center gap-2">
                                <span className="text-sm font-bold tabular-nums" style={{ fontFamily: "var(--font-mono)", color: "var(--text-primary)" }}>
                                    {item.value}
                                </span>
                                {item.killed !== undefined && item.killed > 0 && (
                                    <span className="text-[10px] font-semibold px-1.5 py-0.5 rounded tabular-nums"
                                        style={{ fontFamily: "var(--font-mono)", background: "rgba(255,65,54,0.1)", color: "var(--color-urgent)" }}
                                    >
                                        {item.killed} killed
                                    </span>
                                )}
